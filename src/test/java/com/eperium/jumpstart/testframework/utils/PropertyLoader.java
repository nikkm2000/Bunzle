...
public class PropertyLoader {
	...
	private static void loadPropertiesResources() {
	    ...
	    InputStream in = PropertyLoader.class
	            .getResourceAsStream("/resources/PropertyResources.properties");
	    try {
	        prop.load(in);
	        in.close();
	    } catch (IOException e) {
	...
	public static Properties getUrlPropertiesFile(String urlFileKey) throws Exception{
	    ...
	    return propertyFile;
	    	...
	    	throw new Exception("URL Property not Found for urlFileKey  :  "+urlFileKey);
	    }
	  }
...
public static Properties getSKUpropertiesFile(String dataFileKey) throws Exception{
	...
	public static Properties getLocalizationPropertiesFile(String localeFileKey) throws Exception{
		...
		if(localizationFile != null){
			propertyFile = new Properties();
			InputStream in = PropertyLoader.class
		            .getResourceAsStream(localizationFile);
			try {
	...
	private static void loadURLResources() {
	    ...
	    InputStream in = PropertyLoader.class
	            .getResourceAsStream(prop.getProperty("URLRepository"));
	    try {
	...
	private static void loadSKUResources() {
	    ...
	    InputStream in = PropertyLoader.class
	            .getResourceAsStream(prop.getProperty("SKURepository"));
	    try {
	...
	private static void loadDataResources() {
	    ...
	    InputStream in = PropertyLoader.class
	            .getResourceAsStream(prop.getProperty("DataRepository"));
	    try {
	...
	private static void loadLocalizationResources() {
	    ...
	    InputStream in = PropertyLoader.class
	            .getResourceAsStream(prop.getProperty("LocalizationRepository"));
	    try {
	...
	private static void loadXMLResources() {
	    ...
	    InputStream in = PropertyLoader.class
	            .getResourceAsStream(prop.getProperty("XMLRepository"));
	    try {
